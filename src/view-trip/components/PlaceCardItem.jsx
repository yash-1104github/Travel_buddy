    ...
    return (
        <>
            <Link to={'https://www.google.com/maps/search/?api=1&query=' + place.placeName} target="_blank">
                <div className="border-white  rounded-xl mt-3  flex hover:scale-105 transition-all duration-300 cursor-pointer">
                    ...
                    <div className=" ml-3 hover:shadow-lg border-rounded ">
                        <h2 className="font-bold text-base">{place.placeName}</h2>
                        <p className="text-base text-gray-700">{place.placeDetail}</p>
                        <h2 className="mt-2 text-base font-medium">Price: {place.ticketPricing ?  place.ticketPricing : 'N/A'}</h2>
