        ...
        <div className="grid md:grid-cols-3 gap-5 mt-5 ">
          ...
          {SelectBudgetOptions.map((item, index) => (
            <div key={index}
              ...
              className={`p-4 border bg-zinc-100 rounded-lg hover:shadow-lg card-hover-effect transition-shadow duration-400 ease-in-out cursor-pointer ${formData?.budget == item.title && 'shadow-lg border-black'}`}>
