                ...
                <div className="grid md:grid-cols-3 gap-5 mt-5 ">
                    ...
                    {SelectTravelLists.map((item, index) => (
                        <div key={index}
                            ...
                            className={`p-4 border rounded-lg bg-zinc-100 hover:shadow-lg cursor-pointer card-hover-effect  transition-shadow duration-400 ease-in-out  ${formData?.traveler == item.people && 'shadow-lg border-black'}`}>
